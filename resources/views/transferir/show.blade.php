    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading"><a href="{{route('servidor.index')}}">Servidores</a> - Excluir as opçoes de transferencia da servidora:</div>
                <br>
                <ul class="list-group">
                ...
                <br><br>
                {!! Form::open(['method' => 'POST', 'url' => route('transferir.destroy', $servidor->idservidor), 'class' => 'form-horizontal']) !!}
